---
title: Learning and Decision-making Lab Members
layout: page
group: members
---
...
<div id = "{{person.name}}" class="row" style="padding-top: 60px; margin-top: -60px;">
    <div class="col-sm-4">
        ...
        {% endif %}
        {% if person.CV %}
          <a href= "http://scholar.google.com/citations?user={{person.scholar}}"> CV </a> <br>
        {% endif %}
        {% if person.twitter %}
...
<hr>
{% endfor %}
<a class="btn zoombtn" href="{{ site.url }}/alumni">
Alumnis
</a>
